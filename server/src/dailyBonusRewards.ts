...
export const DAILY_BONUS_REWARDS: DailyBonusReward[] = [
  { day: 1, chips: 50_000, gems: 0, label: '50K Chips' },
  { day: 2, chips: 75_000, gems: 0, label: '75K Chips' },
  { day: 3, chips: 0, gems: 3, label: '3 Gems' },
  { day: 4, chips: 100_000, gems: 0, label: '100K Chips' },
  { day: 5, chips: 0, gems: 5, label: '5 Gems' },
  { day: 6, chips: 150_000, gems: 5, label: 'Gift Box' },
  { day: 7, chips: 300_000, gems: 15, label: 'Grand Jackpot' },
];
